...
/* harmony default export */ __webpack_exports__["default"] = (({
  ...
  request__WEBPACK_IMPORTED_MODULE_0___default()({
    uri: `https://www.collinsdictionary.com/dictionary/french-english/${Object(_utils_strUtils__WEBPACK_IMPORTED_MODULE_2__["encodeAccents"])(word)}`
  }, (err, response, body) => {
    if (err) {
      console.error(err);
      res.status(500);
    ...
    let $ = cheerio__WEBPACK_IMPORTED_MODULE_1___default.a.load(body); // link to infinitive

    const seeAlso = $($('.sense')[0]).find('.ref');

    if (seeAlso.length) {
      request__WEBPACK_IMPORTED_MODULE_0___default()({
        uri: `https://www.collinsdictionary.com/dictionary/french-english/${Object(_utils_strUtils__WEBPACK_IMPORTED_MODULE_2__["encodeAccents"])(seeAlso.text())}`
        ...
        $ = cheerio__WEBPACK_IMPORTED_MODULE_1___default.a.load(body2);
        const defList = [];
...
/***/ 3:
/*!********************************************!*\
  !*** multi ./pages/api/collins/[word].tsx ***!
  \********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /Users/kashi-lab/github/tangochou/pages/api/collins/[word].tsx */"./pages/api/collins/[word].tsx");
